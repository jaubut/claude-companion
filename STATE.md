...
- [ ] Phase 6b (iOS): channel model + picker menu + new-channel sheet + per-channel turn/task filter + badges; handle `orchestrator_channel` frame. xcodebuild + mobile-ux gate.
