...
Generated by archmap on 2026-09-23. Do not edit; regenerate with `bun run ~/.claude/tools/archmap/cli.ts .` (or `tools/archmap/cli.ts .` where vendored).
...
## server (bun-server, `server/`, 56 modules, cap 600)
...
| `lib/transcript.ts` | 410 | lib | 10 | state: states: Map |
...
| `lib/media.ts` | 211 | lib | 7 | state: let mediaBytes, let seededFor, let active, inflight: Map |
...
| `lib/feed.ts` | 128 | lib | 9 | state: feedListeners: Set, feedResetListeners: Set, feedEvictListeners: Set |
