...
## server (bun-server, `server/`, 60 modules, cap 600)

⚠ over cap: `lib/transcript.ts` (617)

| module | lines | kind | exports | contracts |
|---|---|---|---|---|
| `lib/transcript.ts` | 617 ⚠ 617 > cap 600 | lib | 11 | state: states: Map, cursors: WeakMap, busyImages: WeakMap |
