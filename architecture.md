...
## server (bun-server, `server/`, 48 modules, cap 600)
...
| `companion-server.ts` | 87 | route-host | 1 | routes: 5 |
...
| `parseDialog()` | `lib/dialogs.ts` | `lib/dialog-watch.ts`, `lib/model-control.ts` |
